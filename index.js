const contentLetterSrart_actived = "♡ Tui chợt nhớ ra hôm nay là một ngày đặc biệt, là ngày mà một thiên thần đáng yêu đã sinh ra. Hãy luôn mỉm cười thì may mắn sẽ tới nhé bạn ♡" //Lời mở đầu cho bức thư
const mainContentLetter = "♡ Chúc bạn tuổi mới thêm may mắn, thêm nhiều tiền, thêm nhiều niềm vui nhé bạn ♡" //Nội dung của bức thư
...
document.querySelector(".recieve").addEventListener("click", () => {
    var audio = new Audio("sound/happy-birthday-to-you-bossa-nova-style-arrangement-21399.mp3");
    audio.play();
